################################################################################
#
# Adaptation of the file main_script.R (as provided in the repo. https://github.com/sbuis/AgMIP-Calibration-Phase-IV) 
# for the application on synthetic data using the STICS soil-crop model. 
#
# Author: Samuel Buis
################################################################################
#
...
xls_path <- "data//French_example_STICS_BUIS.xlsx"
...
if(!require("SticsRFiles")) {
  devtools::install_github("SticsRPacks/SticsRFiles@v1.1.3")
  library("SticsRFiles")
}
if(!require("SticsOnR")) {
  devtools::install_github("SticsRPacks/SticsOnR@v1.1.0")
  library("SticsOnR")
}
...
data_dir= file.path(here(), "stics_input_files",
                    test_case,"TxtFiles")
...
use_obs_synth <- TRUE
beta <- 0.6 # level of perturbation of parameters values : 0.3 or 0.6
noise_sd <- 0.1 # sd of gaussian noise added to synthetic observations (in percentage, set 0 or 0.1)
